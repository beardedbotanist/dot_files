...
export TRUSTED_GPGKEY_FINGREPRINT="CC49AAC2E34FC520DCC22C066BC64EF2DED8EE55"
export PINENTRY_PROGRAM="/opt/homebrew/bin/pinentry-mac"
export GIT_HIGHLANDER="https://raw.githubusercontent.com/beardedbotanist/dotfiles/init/scripts/bootstrap/highlander.asc"
...
# chezmoi init https://github.com/beardedbotanist/dot_files.git --apply
# chezmoi init beardedbotanist
# decrypt_files
# chezmoi apply